...
- For scripted or dramatic continuity editing, read [references/narrative.md](references/narrative.md). A screenplay, outline, or explicit scene intent is normally required; music is not required for the assembly cut.
...
4. Build the project-specific editorial strategy from the material, script or soundtrack, and requested outcome. Do not reuse the arc, shot order, pacing, grade, titles, or packaging of a previous project.
